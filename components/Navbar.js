    ...
    >
      ...
      {isNotepad && !minimizeNotepad && (
        <ProgramComponent
          ...
          initialSize={getInitialSize('notepad')}
      ...
      {isPaint && !minimizePaint && (
        <ProgramComponent
          ...
          initialSize={getInitialSize('paint')}
          saveable={true}
          setItems={setItems}
          opennable={true}
          help={false}
      ...
      {isExplorer && !minimizeExplorer && (
        <ProgramComponent
          ...
          initialSize={getInitialSize('explorer')}
          saveable={false}
          opennable={false}
          help={false}
      ...
      {isBriefcase && !minimizeBriefcase && (
        <ProgramComponent
          ...
          initialSize={getInitialSize('briefcase')}
          saveable={false}
          opennable={true}
          help={false}
          isDirectory={isDirectory}
      ...
      {isOutlook && !minimizeOutlook && (
        <ProgramComponent
          ...
          initialSize={getInitialSize('outlook')}
          titleData={subject}
          saveable={false}
          opennable={false}
          help={false}
      ...
      {isMinesweeper && !minimizeMinesweeper && (
        <ProgramComponent
          ...
          initialSize={getInitialSize('minesweeper')}
          saveable={false}
          opennable={false}
          help={false}
          helpHandler={helpHandler}
      ...
      {isHelp && !minimizeHelp && (
        <ProgramComponent
          ...
          initialSize={getInitialSize('help')}
          saveable={false}
          opennable={false}
          help={true}
        >
      ...
      {isRecycleBin && !minimizeRecycleBin && (
        <ProgramComponent
          ...
          initialSize={getInitialSize('recycle')}
          saveable={false}
          opennable={false}
          help={false}
      ...
      {isWorks && !minimizeWorks && (
        <ProgramComponent
          ...
          initialSize={getInitialSize('works')}
          saveable={false}
          opennable={true}
          help={false}
          helpHandler={helpHandler}
